	...
	public partial class Game : Sandbox.Game
	{
		...
		public static void SpawnSphere( int count = 1 )
		{
			...
			for ( var i = 0; i < count; ++i )
			{
				...
				voxels.Add( new SphereSdf( centerRange.RandomPointInside, radius, smoothing ), Matrix.Identity, 8f, 0 );
			}
		...
		public static void SpawnBoxes( int count = 1 )
		{
			...
			for ( var i = 0; i < count; ++i )
			{
				...
				voxels.Add( new BoundsSdf( center - size * 0.5f, center + size * 0.5f, smoothing ), Matrix.Identity, 8f, 0 );
			}
